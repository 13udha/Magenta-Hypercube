...
The repository contains a set of Python modules that help in creating a microservice service the skill implementation, a wrapper that abstracts the HTTP calls into Python function call and some other helpful libraries.
